 ...
 */
package com.find.duplicate.files.desktoppane.menu;
...
import com.find.duplicate.files.actions.NewAction;
import com.find.duplicate.files.actions.OpenBrowserToDonateAction;
import com.find.duplicate.files.actions.ShowHelpDialogAction;
import com.find.duplicate.files.actions.ShowInfoDialogAction;
import com.find.duplicate.files.actions.ShowLicenseFrameAction;
...
public class DesktopMenu {
	 ...
	 *
	 * @param helpWindow the new help window
	 */
     ...
     * @return the j menu
     */
    private JMenu createLookAndFeelMenu(ActionListener listener){
	...
	private JMenu createHelpMenu(ActionListener listener) {
		// Help menu
		JMenu menuHelp = new JMenu("Help"); //$NON-NLS-1$
		menuHelp.setMnemonic('H');

		// Help JMenuItems
		// Help content
		JMenuItem mihHelpContent = new JMenuItem("Content", 'c'); //$NON-NLS-1$
